...
/***************************************************************************//**
 * @brief
 *  Function initializes the i2c peripheral to start a write or read
 *
 * @details
 *  This function sets values to either i2c0_state_struct or i2c1_state_struct.
 *  Then, it blocks the energy mode 2, sets the i2c busy bit as true, and sets
 *  the i2c current state to initialize.
 *
 * @note
