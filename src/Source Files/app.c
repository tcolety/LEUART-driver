 ...
 * @details
 *          This function changes static variables x and y, divides them, and sends
 *          the result to be displayed on the bluetooth device.
 *
 * @note
 *          Function multiplying y by 1.0 turns the result into a floating point
 ******************************************************************************/
...
/*******************************************************************************
 * @brief
 *  Reads the value for the Si1133 light sensor, compares that value to 20,
 *  and sends the result to the bluetooth module.
 *
 * @details
 *  scheduled_si1133_light_read_cd() calls si1133_get_read_reseult to get the
 *  reading of the light sensor. If th eresult is less than 20, the it turns on
 *  LED 1 and sends "It's dark = " & the result to the device connected
